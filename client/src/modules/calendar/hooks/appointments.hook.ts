...
import { AppointmentDateMap } from '../data/types/appointment-datemap.type';
import { getAvailableAppointments } from '../services/appointment.service';
import { getMonthYearDetails, getNewMonthYear } from '../../../shared/services/month-year.service';
import { IMonthYear } from '../data/interfaces/month-year.interface';
...
export function useAppointments(): UseAppointments {
  ...
  const selectFn = useCallback((appointments: AppointmentDateMap) => {
  ...
  useEffect(() => {
    ...
    queryClient.prefetchQuery(
      [queryKeys.appointments, nextMonthYear.month],
  ...
  const { data: appointments = {} } = useQuery([queryKeys.appointments, monthYear.month, monthYear.year], 
